...
class SOLUTION():
    ...
    def Create_Body(self):
        ...
        pyrosim.Send_Joint(name="Torso_RightLeg", parent="Torso", child="RightLeg", type="revolute", position=[-0.5, 0, 0], jointAxis = "0 1 0")
        pyrosim.Send_Cube(name="RightLeg", pos=[0, 0, 0], size=[.2, 1, .2])
        pyrosim.End()
